...
@register_function(
    ...
    auto_fix="none",
    examples=[
        "adata = st.io.single.read_h5ad('pbmc3k.h5ad')",
        "adata = st.io.single.read_h5ad('sample.h5ad', backed='r')",
    ],
...
def read_h5ad(filename, **kwargs):
    ...
    **kwargs
    ...
    anndata.AnnData
    """
    adata = _anndata_read_h5ad(filename, **kwargs)
...
@register_function(
    ...
    auto_fix="none",
    examples=[
        "adata = st.io.single.read_10x_h5('filtered_feature_bc_matrix.h5')",
        "adata = st.io.single.read_10x_h5('filtered_feature_bc_matrix.h5', gex_only=True)",
    ],
...
@register_function(
    ...
    auto_fix="none",
    examples=[
        "adata = st.io.single.read_10x_mtx('filtered_feature_bc_matrix')",
        "adata = st.io.single.read_10x_mtx('filtered_feature_bc_matrix', var_names='gene_ids')",
    ],
